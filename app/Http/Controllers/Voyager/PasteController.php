...
class PasteController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $product = Paste::where('id', $id)->first();
        $ingrediente = json_decode($product->ingrediente);
        $toppings = json_decode($product->toppings);
        $selectedPaste = $product->id_api;
        $selectedPasteName = $product->nume;

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'paste', 'ingrediente', 'selectedPaste', 'toppings', 'selectedPasteName'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // dd($request->all());
        Paste::where('id', $id)->update(array('ingrediente' => $request->ingrediente, 'id_api' => $request->paste, 'nume' =>$request->pastename, 'toppings' => $request->toppings));
    ...
    public function create(Request $request)
    {
        ...
        $paste = $ProductsApi->getPaste();
        $toppings = collect([]);
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'paste', 'toppings'));
    }
    ...
    {   
        $pasteFounded = Paste::where('id_api', $request->paste)->first();
        if($pasteFounded){
            $redirect = redirect()->back();
            return $redirect->with([
                'message'    => "Paste deja adaugata",
                'alert-type' => 'error',
            ]);
        }
        ...
        Paste::where('id', $data->id)->update(array('ingrediente' => $request->ingrediente, 'id_api' => $request->paste, 'nume' =>$request->pastename, 'toppings' => $request->toppings));
