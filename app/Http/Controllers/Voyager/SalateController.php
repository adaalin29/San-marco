...
class SalateController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $product = Salata::where('id', $id)->first();
        $ingrediente = json_decode($product->ingrediente);
        $toppings = json_decode($product->toppings);
        $selectedSalata = $product->id_api;
        $selectedSalataName = $product->nume;

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'salate', 'ingrediente', 'selectedSalata', 'toppings', 'selectedSalataName'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // dd($request->all());
        Salata::where('id', $id)->update(array('ingrediente' => $request->ingrediente, 'id_api' => $request->salata, 'nume' =>$request->salataname, 'toppings' => $request->toppings));
    ...
    public function create(Request $request)
    {
        ...
        $salate = $ProductsApi->getSalate();
        $toppings = collect([]);
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'salate', 'toppings'));
    }
    ...
    {   
        $salataFounded = Salata::where('id_api', $request->salata)->first();
        if($salataFounded){
            $redirect = redirect()->back();
            return $redirect->with([
                'message'    => "Salata deja adaugata",
                'alert-type' => 'error',
            ]);
        }
        ...
        Salata::where('id', $data->id)->update(array('ingrediente' => $request->ingrediente, 'id_api' => $request->salata, 'nume' =>$request->salataname, 'toppings' => $request->toppings));
