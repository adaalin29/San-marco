...
class SandwichController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $product = Sandwich::where('id', $id)->first();
        $ingrediente = json_decode($product->ingrediente);
        $toppings = json_decode($product->toppings);
        $selectedSandwich = $product->id_api;
        $selectedSandwichName = $product->nume;

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'sandwichuri', 'ingrediente', 'selectedSandwich', 'toppings', 'selectedSandwichName'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // dd($request->all());
        Sandwich::where('id', $id)->update(array('ingrediente' => $request->ingrediente, 'id_api' => $request->sandwich, 'nume' =>$request->sandwichname, 'toppings' => $request->toppings));

        // dd(Pizza::where('id', $id)->first());
    ...
    public function create(Request $request)
    {
        ...
        $sandwichuri = $ProductsApi->getSandwichuri();
        $toppings = collect([]);
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'sandwichuri', 'toppings'));
    }
    ...
    {   
        $sandwichFounded = Sandwich::where('id_api', $request->sandwich)->first();
        if($sandwichFounded){
            $redirect = redirect()->back();
            return $redirect->with([
                'message'    => "Sandwich deja adaugat",
                'alert-type' => 'error',
            ]);
        }
        ...
        Sandwich::where('id', $data->id)->update(array('ingrediente' => $request->ingrediente, 'id_api' => $request->sandwich, 'nume' =>$request->sandwichname, 'toppings' => $request->toppings));
