...
class PizzaController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $selectedPizza = $product->id_api;
        $selectedPizzaName = $product->nume;

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'pizzas', 'ingrediente', 'selectedPizza', 'toppings', 'selectedPizzaName'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // dd($request->all());
        Pizza::where('id', $id)->update(array('ingrediente' => $request->ingrediente, 'id_api' => $request->pizza, 'nume' =>$request->pizzaname, 'toppings' => $request->toppings));
    ...
    public function create(Request $request)
    {
        ...
        $pizzas = $ProductsApi->getPizzas();
        $toppings = collect([]);
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'pizzas', 'toppings'));
    }
    ...
    {   
        $pizzaFounded = Pizza::where('id_api', $request->pizza)->first();
        if($pizzaFounded){
            $redirect = redirect()->back();
            return $redirect->with([
                'message'    => "Pizza deja adaugata",
                'alert-type' => 'error',
            ]);
        }
        ...
        Pizza::where('id', $data->id)->update(array('ingrediente' => $request->ingrediente, 'id_api' => $request->pizza, 'nume' =>$request->pizzaname, 'toppings' => $request->toppings));
