...
?>
<div class = "container">
  @foreach(array_chunk($salate['products'],4) as $produse)
        ...
        <div class = "produs">
          ...
          ?>
            <div class = "produs-descriere">{{implode(", ", $toppings)}}</div>
                         ...
                         <?php
                          $faraDressing = $data['optionals'][0]['optionalsContent'][2];
                          
                          $data['optionals'] = $faraDressing;
                        ?>
                    ...
                    <div class = "produs-pret-img"><img class = "full-width" style = "object-fit:cover;" src = "images/buton-cart.svg"></div>
                        ...
                        <a href = "/detaliu-salata/{{$data['productId']}}" class = "produs-buton-custom">
