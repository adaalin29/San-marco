                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <label class="control-label" for="name">Paste</label>
                            <input id='paste-name' type="hidden" name="pastename" @if(isset($selectedPasteName)) value="{{$selectedPasteName}}" @else value="" @endif>
                            @if(isset($ingrediente))
                            <input id='selected-ingrediente' type="hidden" value='{{json_encode($ingrediente)}}'>
                            @endif
                            <select required id="paste" name="paste" class="form-control select2">
                                <option value="">None</option>
                                
                                @foreach($paste['products'] as $pasta)
                                @if(isset($selectedPaste))
                                @if($pasta['productId'] == $selectedPaste)
                                <option selected value="{{$pasta['productId']}}" data-ingrediente="{{json_encode($pasta['removableToppings'])}}">{{$pasta['name']}}</option>
                                @else
                                <option value="{{$pasta['productId']}}" data-ingrediente="{{json_encode($pasta['removableToppings'])}}">{{$pasta['name']}}</option>
                                @endif
                                @else
                                <option value="{{$pasta['productId']}}" data-ingrediente="{{json_encode($pasta['removableToppings'])}}">{{$pasta['name']}}</option>
                                @endif
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php
                                foreach($paste['extraToppings'] as $topping){
                                    $found = false;
                                    if($toppings){
...
@section('javascript')
    <script>
        $( "#paste" ).change(function() {
            ...
            $('#paste-name').val($( "#paste option:selected" ).text())
            var ingrediente = $( "#paste option:selected" ).data("ingrediente")
